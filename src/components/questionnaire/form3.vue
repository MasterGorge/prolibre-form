      ...
      return {
        ...
        language: new LanguageModel(),
         questions: [
          ...
          new QuestionModel({
            id: '',
            title: "Avez-vous un/plusieurs pare-feu dans votre entreprise?",
            type: QuestionType.MultipleChoice,
            multiple: false,
            required: true,
            options: [
              new ChoiceOption({
                label: 'Externe/Matériel',
              }),
              new ChoiceOption({
                label: 'Interne/Logiciel',
              }),
              new ChoiceOption({
                label: 'Oui',
              }),
          ...
          new QuestionModel({
            id: '',
            title: "Couvrent-il(s) l'intégralité du réseau?",
            type: QuestionType.MultipleChoice,
            multiple: false,
            required: true,
            options: [
          ...
          new QuestionModel({
            id: '',
            title: "Utilisez-vous la norme PCI DSS pour protéger les données sur les cartes de payements?",
            helpText:"L'acronyme PCI DSS (Payment Card Industry Data Security Standard) désigne les normes de sécurité des données applicables à l'industrie des cartes de paiement. Élaborée par le conseil des normes de sécurité PCI, la norme PCI DSS vise à réduire la fraude en ligne",
            type: QuestionType.MultipleChoice,
            multiple: false,
            required: true,
            options: [
          ...
          new QuestionModel({
            id: '',
            title: "Faites vous un chiffrement des données pour les protéger?",
            helpText:"Le chiffrement des données est un procédé de codage qui consiste à sécuriser un document en le convertissant à l'aide d'un algorithme. Pour établir une telle action sur des fichiers, il est nécessaire d'utiliser une clé de chiffrement, et à l'inverse une clé de déchiffrement pour les lire",
            type: QuestionType.MultipleChoice,
            multiple: false,
            required: true,
            options: [
          ...
          new QuestionModel({
            id: '',
            title: "Connaissez vous le cadre juridiques suisse et la LPD?",
            helpText:"Aide pour le cadre juridique: www.hesge.ch/heg/sites/default/files/ccsie/documents/ressources-cadre-juridique-pme.pdf <br> Lpd: La Loi fédérale sur la protection des données",
            type: QuestionType.MultipleChoice,
            multiple: false,
            required: true,
            options: [
              ...
              new ChoiceOption({
                label: 'Oui mais toutes ces lois',
              }),
              new ChoiceOption({
                label: 'Non',
              }),
          ...
          new QuestionModel({
            id: '',
            title: "Connaissez-vous les Cyber assurances?",
            helpText:"",
            type: QuestionType.MultipleChoice,
            multiple: false,
            required: true,
            options: [
              new ChoiceOption({
                label: 'Oui, nous en possédons une',
              }),
              new ChoiceOption({
                label: "Oui, mais nous n'en possédons pas",
              }),
              new ChoiceOption({
